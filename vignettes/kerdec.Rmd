...
requireNamespace(dplyr, quietly = TRUE)  # To handle data frames
requireNamespace(tidyr, quietly = TRUE)                          # To handle data frames
requireNamespace(ggplot2, quietly = TRUE)                        # Load generate plot
...
```{r}
## Load package 
requireNamespace(fourierin, quietly = TRUE)
library(kerdec)
