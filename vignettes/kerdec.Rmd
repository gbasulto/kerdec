...
eps_panel1 <- matrix(rlaplace(n*l, sd = sd_error),
                    n, l)               # Panel of errors
eps_panel2 <- matrix(rlaplace(n*l, sd = sd_error),
                    n, l)               # Panel of errors
eps1 <- rlaplace(m, sd = sd_error)       # Pure errors
eps2 <- rlaplace(m, sd = sd_error)       # Pure errors
