...
/* Deconvolution formula when a sample of pure errors is available, which is independent from the signal. */
arma::cx_vec kerdec_dens_pure(arma::mat smp, arma::mat error_smp, double cutoff, int resolution)
{
